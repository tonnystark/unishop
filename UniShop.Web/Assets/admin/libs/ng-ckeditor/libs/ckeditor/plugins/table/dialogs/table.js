        ...
        return{
            ...
            onShow: function() {
                ...
                ((g = g.getSelectedElement()) && g.is("table")
                    ...
                    (CKEDITOR.env
                        .webkit &&
                        d[0].shrink(CKEDITOR.NODE_ELEMENT), c = a.elementPath(d[0]
                            .getCommonAncestor(!0))
                        .contains("table", 1)), this._.selectedElement = c);
                ...
                if (b.info) {
                    ...
                    if (!this._.selectedElement)
                        for (var h = c.append(l("tbody")),
                            ...
                            i = 0;
                            i < e;
                            i++) for (var j = h.append(l("tr")), k = 0; k < f; k++) j.append(l("td")).appendBogus();
                    e = b.selHeaders;
                    ...
                    if (this
                        ...
                        for (i = 0;
                            ...
                            j = new CKEDITOR.dom.element(c.$
                                .rows[i]), "tbody" == j.getParent().getName() &&
                            (f = new CKEDITOR.dom.element(j.$.cells[0]), f.renameNode("td"), f
                                    ...
                                    children: [
                                        {
                                            ...
                                            [a.lang.common.alignCenter, "center"], [a.lang.common.alignRight, "right"]
                                            ],
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    "default":
                                                        a.filter.check("table{width}")
                                                            ? 500 > n.getSize("width") ? "100%" : 500
                                                            : 0,
                                                    getValue: q,
                                                    validate: CKEDITOR.dialog.validate
                                                        .cssLength(a.lang.common.invalidCssLength
