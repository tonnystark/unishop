    ...
    function(j) {
        ...
        function p(b) {
            for (var b = ("" + b)
                ...
                e = b.length;
                a < e;
                a += 1) f.getById(b[a]).$.style.display = "inline"
        }
        ...
        function q(b) {
            for (var b = ("" + b)
                ...
                e = b.length;
                a < e;
                a += 1) f.getById(b[a]).$.style.display = "none"
        }
            ...
            B = {
                ...
                onShow: function() {
                    ...
                    if (!b
                        .data ||
                        !b.data.scayt ||
                        !b.data.scayt_control) alert("Error loading application service"), b.hide();
                    else {
                        var a = 0;
                        s
        ...
        var A = function() {
                ...
                if (1 ==
                    ...
                    for (c in v)
                        d = "label_" + v[c], g = f
                            .getById(d + "_" + a), "undefined" != typeof g &&
                ...
                d = function(a, b) {
                    ...
                    var d = f.createElement("div"),
                        e = CKEDITOR.dom.element
                            .createFromHtml('<input class = "cke_dialog_ui_radio_input" id="cke_option' +
                                a +
                                '" type="radio" ' +
