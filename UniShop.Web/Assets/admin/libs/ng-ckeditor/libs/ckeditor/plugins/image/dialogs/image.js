    ...
    var r = function(c, j) {
            ...
            if (!s) {
                ...
                if (d) {
                    ...
                    for (var a = []
                        ...
                        g = 0;
                        g < e;
                        g++) (c = b.getContentElement.apply(b, a[g].split(":"))) && c.setup(f, d)
                }
                s = 0
            }
        }
        ...
        var f = 1,
            ...
            w = function() {
                ...
                ("txtHeight" == this.id
                    ...
                    : (a && "0" != a && (a = Math.round(d.$.height * (a / d.$.width))),
        ...
        return{
            ...
            onShow: function() {
                ...
                if (d) {
                    ...
                    if (1 == c.count()) {
                        ...
                        if ("img" == g || "input" == g)
                            this.imageElement = c
                                .getItem(0), "img" == this.imageElement.getName()
                ...
                if (this.customImageElement)
                    this.imageEditMode = "img", this
                        .imageElement = this.customImageElement, delete this.customImageElement;
                ...
                this.imageEditMode
                    ? (this.cleanImageElement = this.imageElement, this.imageElement = this.cleanImageElement
                        .clone(!0, !0), this.setupContent(f, this.imageElement))
            ...
            onOk: function() {
                if (this.imageEditMode) {
                    ...
                    "image" == j && "input" == a && confirm(c.lang.image.button2Img)
                        ? (this.imageElement = c.document.createElement("img"), this.imageElement
                            .setAttribute("alt", ""), c
                        ...
                        ? (this.imageElement = c.document.createElement("input"),
                            this.imageElement.setAttributes({ type: "image", alt: "" }), c
                                .insertElement(this.imageElement))
                        : (this.imageElement = this.cleanImageElement, delete this.cleanImageElement)
                } else
                    "image" == j
                        ? this.imageElement = c.document.createElement("img")
                        : (this.imageElement = c.document.createElement("input"), this.imageElement
                            .setAttribute("type", "image")), this.imageElement.setAttribute("alt", "");
            ...
            onLoad: function() {
                ...
                (this.addFocusable(a.getById(u), 5), this.addFocusable(a.getById(p), 5));
                this.commitContent = r
            },
            onHide: function() {
                this.preview && this.commitContent(8, this.preview);
                this.originalElement &&
                (this.originalElement.removeListener("load", q), this.originalElement.removeListener("error", h), this
                    .originalElement.removeListener("abort", h), this.originalElement.remove(), this.originalElement =
                    !1);
                    ...
                    elements: [
                        {
                                    ...
                                    children: [
                                        {
                                            ...
                                            onChange: function() {
                                                ...
                                                if (0 < b.length) {
                                                    ...
                                                    a.preview &&
                                                    (a.preview.removeAttribute("src"), a.preview
                            ...
                            commit: function(a,
                                ...
                                a == f
                                    ...
                                    : 4 == a ? b.setAttribute("alt", this.getValue()) : 8 == a && b.removeAttribute("alt")
                            }
                        }, {
                            type: "hbox",
                            children: [
                                                    ...
                                                    children: [
                                                        {
                                                            ...
                                                            onKeyUp: w,
                                                            onChange:
                                                                function() { i.call(this, "advanced:txtdlgGenStyle") },
                                                            validate: function() {
                                                            ...
                                                            commit: function(a, b, d) {
                                                                ...
                                                                a == f
                                                                    ? (c
                                                                        ? b
                                                                        .setStyle("width", CKEDITOR.tools.cssLength(c))
                                                                        : b
                                                                        .removeStyle("width"),
                                                            ...
                                                            commit: function(a, b, d) {
                                                                ...
                                                                a == f
                                                                    ? (c
                                                                        ? b
                                                                        .setStyle("height", CKEDITOR.tools.cssLength(c))
                                                                        : b
                                                                        .removeStyle("height"),
                                                        ...
                                                        (b.on("click",
                                                            function(a) {
                                                                ...
                                                                if (b.getCustomData("isReady") == "true" && c) {
                                                                    ...
                                                                    if (!isNaN(b)) {
                                                                        this
                                                                            .setValueOf("info", "txtHeight", Math.round(b));
                                                                        g(this)
                                                                    }
                                                                }
                                                                a.data && a.data.preventDefault()
                                                    ...
                                                    commit: function(a, b, d) {
                                                        ...
                                                        a == f || 4 == a
                                                            ? (isNaN(c)
                                                                    ...
                                                                    : (b
                                                                            .setStyle("border-width", CKEDITOR.tools.cssLength(c)),
                                                                        b
                                                                            .setStyle("border-style", "solid")),
                                                                !d && a == f && b.removeAttribute("border"))
                                                            : 8 == a &&
                                                            (b.removeAttribute("border"), b
                                                    ...
                                                    commit: function(a, b, c) {
                                                        ...
                                                        a == f || 4 == a
                                                            ? (isNaN(e)
                                                                    ? !e &&
                                                                    this.isChanged() &&
                                                                    (b.removeStyle("margin-left"), b
                                                                        .removeStyle("margin-right"))
                                                                    : (b
                                                                        .setStyle("margin-left", CKEDITOR.tools.cssLength(e)), b
                                                                        .setStyle("margin-right", CKEDITOR.tools.cssLength(e))),
                                                                !c && a == f && b.removeAttribute("hspace"))
                                                            : 8 == a &&
                                                            (b.removeAttribute("hspace"), b
                                                    ...
                                                    commit: function(a, b, c) {
                                                        ...
                                                        a == f || 4 == a
                                                            ? (isNaN(e)
                                                                    ? !e &&
                                                                    this.isChanged() &&
                                                                    (b.removeStyle("margin-top"), b
                                                                        .removeStyle("margin-bottom"))
                                                                    : (b
                                                                        .setStyle("margin-top", CKEDITOR.tools.cssLength(e)), b
                                                                        .setStyle("margin-bottom", CKEDITOR.tools.cssLength(e))),
                            ...
                            children: [
                                {
                                    ...
                                    commit: function(a, b) { a == f && (this.getValue() || this.isChanged()) && b.setAttribute("id", this.getValue()) }
                                }, {
                                    id: "cmbLangDir",
                                    type: "select",
