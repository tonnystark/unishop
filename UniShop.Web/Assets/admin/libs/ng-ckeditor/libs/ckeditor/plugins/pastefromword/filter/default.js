...
(function() {
    function y(a) {
        ...
        f = 0;
        f < c;
        ++f) for (var d = z[f], e = d[1].length; a.substr(0, e) == d[1]; a = a.substr(e)) b += d[0];
        return b
    }
    ...
    function A(a) {
        ...
        f = 1;
        0 < a.length;
        f *= c) b += B.indexOf(a.charAt(a.length - 1)) * f, a = a.substr(0, a.length - 1);
        return b
    }
            ...
            filters: {
                ...
                assembleList: function(a) {
                    for (var c = a.children, b, f, d, e, h, j, a = [], g, m, i, l, k, p, n = 0; n < c.length; n++)
                        if (b = c[n], "cke:li" == b.name)
                            if (b.name = "li", f = b.attributes, i = (i = f["cke:listsymbol"]) &&
                                    i
                                    .match(/^(?:[(]?)([^\s]+?)([.)]?)$/), l = k = p = null, f["cke:ignored"]
                            ) c.splice(n--, 1);
                            else {
                    ...
                    for (n = 0; n < a.length; n++)
                        if (j =
                            a[n], q = j
                            .children, g = g = void 0, u = j.children
                            .length, r = g = void 0, c = /list-style-type:(.*?)(?:;|$)/, e =
                            CKEDITOR.plugins.pastefromword.filters.stylesFilter, g = j.attributes, !c.exec(g.style)) {
                            for (h = 0; h < u; h++)
                            ...
                            .replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                                function(b, e, g) {
                                    ...
                                    for (var m, i, l, k = 0; k < a.length; k++)
                                        if (a[k] &&
                                        (b = a[k][0], m = a[k][1], i = a[k][2], l = a[k][3],
                    ...
                    elements: {
                        ...
                        p: function(a) {
                            if (/MsoListParagraph/i.exec(a.attributes["class"]) ||
                                a.getStyle("mso-list")) {
                                var b = a
                                    .firstChild(function(a) { return a.type == CKEDITOR.NODE_TEXT && !n(a.parent) });
                        ...
                        font: function(a) {
                            if (p(a.parent)) delete a.name;
                                ...
                                "font" == e.name
                                    ? (CKEDITOR.tools
                                        .extend(e.attributes, a.attributes), d && e.addStyle(d), delete a.name)
                                    : (d = d || "", b.color &&
                                        ("#000000" != b.color && (d += "color:" + b.color + ";"), delete b.color),
                                        b
                                            .face &&
                                            (d += "font-family:" + b.face + ";", delete b.face), b.size &&
                                        (d += "font-size:" +
                    ...
                    comment: !CKEDITOR.env.ie
                        ? function(a, b) {
                            ...
                            return d
                                ...
                                (d = (d = (d = b.previous) && d.value.match(/<v:imagedata[^>]*o:href=['"](.*?)['"]/)) &&
                                    d[1]) &&
