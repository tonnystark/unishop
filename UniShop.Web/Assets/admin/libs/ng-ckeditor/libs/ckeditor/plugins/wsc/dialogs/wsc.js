...
(function() {
    ...
    var e = function() {
            ...
            return{
                ...
                cookie: {
                    set: a,
                    get: function(a) { return(a = document.cookie.match(RegExp("(?:^|; )" + a.replace(/([\.$?*|{}\(\)\[\]\\\/\+^])/g, "\\$1") + "=([^;]*)"))) ? decodeURIComponent(a[1]) : void 0 },
        ...
        b.parts.tabs.on("click",
            function(h) {
                ...
                h.data.getTarget().is("a") &&
                    c != b._.currentTabId &&
                    (c = b._.currentTabId, d = b._.contents[c].Content, f = a.iframeNumber + "_" + c, a.div_overlay
                        .setEnable(), d.getElement().getChildCount()
    ...
    a.buildOptionLang = function(b, c) {
        ...
        if (0 === d.options.length) {
            ...
            for (var k = 0; k < e.length; k++)
                g = document.createElement("option"), g.setAttribute("value", e[k][1]), h = document
                        .createTextNode(e[k][0]),
    ...
    var o = function(a) {
            ...
            i.style
                .cssText =
                "position: absolute;top:30px;bottom:41px;left:1px;right:1px;z-index: 10020;padding:0;margin:0;background:" + a + ";opacity: " + g + ";filter: alpha(opacity=" + 100 * g + ");display: none;";
            i.id = f;
            e || d.appendChild(i);
            return{
            ...
            if ("no_any_suggestions" == b) {
                ...
                a.LocalizationButton.ChangeTo.instance.enable(),
                    a.LocalizationButton.ChangeAll.instance
                        .enable(), a.LocalizationButton.ChangeTo.instance
                        .getElement()
        ...
        A = {
            ...
            options_dic_send: function() {
                ...
                e.postMessage
                    .send({ message: b, target: a.targetFromFrame[a.iframeNumber + "_" + a.dialog._.currentTabId] })
            },
            ...
            return{
                ...
                onShow: function() {
                    ...
                    if (CKEDITOR && CKEDITOR.config) {
                        ...
                        CKEDITOR.scriptLoader.load(b.config.wsc_customLoaderScript ||
                            c +
                            ...
                            function(c) {
                                CKEDITOR.config && CKEDITOR.config.wsc && CKEDITOR.config.wsc.DefaultParams
                                    ? (a.serverLocationHash =
                                            ...
                                            .serviceHost, a
                                            .logotype = CKEDITOR.config.wsc.DefaultParams
                                            .logoPath, a
                                            .loadIcon = CKEDITOR.config.wsc.DefaultParams
                                            .iconPath, a
                                            .loadIconEmptyEditor =
                                    ...
                                    : (a
                                        .serverLocationHash = DefaultParams.serviceHost, a.logotype =
                                        DefaultParams
                                        .logoPath, a
                                        .loadIcon = DefaultParams
                                        .iconPath, a
                                        .loadIconEmptyEditor = DefaultParams.iconPathEmptyEditor, a.LangComparer = new
                                        _SP_FCK_LangCompare);
                                                                ...
                                                                children: [
                                                                    {
                                                                        ...
                                                                        onShow: function() {
                                                                            a.LocalizationLabel.Suggestions
                                                                                .instance = this;
                                ...
                                children: [
                                    {
                                        ...
                                        children: [
                                        {
                                            type: "vbox",
                                            id: "rightCol_col__left",
                                            children: [{ type: "button", id: "FinishChecking", label: "Finish Checking", title: "Finish Checking", style: "width: 100%;", onLoad: function() { this.getElement().setAttribute("title-cmd", this.id) }, onClick: c }]
                                        }
                                        ]
                                    }
                                ]
                                                        ...
                                                        children: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                onLoad:
                                                                    function() {
                                                                        this.getElement()
                                                                            .setAttribute("title-cmd", this.id)
                                                                    },
                                                                onClick: c
                                                            }
                                                        ]
            ...
            return{
                                ...
                                children: [
                                    {
                                        ...
                                        children: [
                                            {
                                                ...
                                                onShow: function() {
                                                    this.getInputElement().$.children[0]
                                                        .innerHTML = a.LocalizationComing.SpellCheckingOptions
                                                },
                                                children: [
                                                    {
                                                        type: "vbox",
                                                        ...
                                                        children: [
                                                            {
                                                                ...
                                                                "default": "",
                                                                onClick:
                                                                    function() { d[this.id] = !this.getValue() ? 0 : 1 }
                                                            }, {
                                                                type: "checkbox",
                                                                ...
                                                                children: [
                                                                    {
                                                                        ...
                                                                        style: "width: 100%;",
                                                                        onLoad: function() { this.getElement().setAttribute("title-cmd", this.id) },
                                                                        onShow: function() { this.getElement().setText(a.LocalizationComing.Create) },
                                                                        onClick: h
                                                                    }, {
                                                                        type: "button",
                                                                        id: "restore",
                                                                ...
                                                                children: [
                                                                    {
                                                                        ...
                                                                        style: "width: 100%;",
                                                                        onLoad: function() { this.getElement().setAttribute("title-cmd", this.id) },
                                                                        onShow: function() { this.getElement().setText(a.LocalizationComing.Rename) },
                                                                        onClick: h
                                                                    }, {
                                                                        type: "button",
                                                                        id: "delete",
                                        ...
                                        children: [
                                        {
                                            ...
                                            onShow: function() { this.getElement().setText(a.LocalizationComing.OptionsTextIntro) }
                                        }
                                        ]
                                    }
                                ]
                ...
                onShow: function() {
                    ...
                    c.IgnoreWordsNumbers
                        .getElement()
                        .$.lastChild.innerHTML = a.LocalizationComing.IgnoreWordsWithNumbers;
                    c.IgnoreMixedCaseWords
                        .getElement()
                        .$.lastChild.innerHTML = a.LocalizationComing.IgnoreMixedCaseWords;
