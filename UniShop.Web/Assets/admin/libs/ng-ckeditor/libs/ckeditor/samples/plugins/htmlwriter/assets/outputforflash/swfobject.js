        ...
        if (c) {
            ...
            (function() {
                if (typeof c.GetVariable != i) {
                    ...
                    g &&
                    (g = g.split(" ")[1].split(","), e
                        .pv = [parseInt(g[0], 10), parseInt(g[1], 10), parseInt(g[2], 10)])
                } else if (10 > f) {
                    f++;
            ...
            for (var b = 0; b < a; b++) {
                ...
                if (0 < e.pv[0]) {
                    ...
                    if (d)
                        if (z(p[b]
                            .swfVersion) &&
                        !(e.wk && 312 > e.wk)) t(c, !0), f && (g.success = !0, g.ref = E(c), f(g));
    ...
    function G(a, b, c, f) {
        ...
        if (g) {
            ...
            (f = d.createElement("div"), c += "SWFObjectNew", f.setAttribute("id",
                c), g.parentNode.insertBefore(f, g), g.style
            ...
            if (typeof a.id == i && (a.id = c), e.ie && e.win) {
                ...
                for (o in b)
                    b[o] != Object.prototype[o] &&
                        "movie" != o.toLowerCase() &&
                        (a = j, h = o, k = b[o], c = d.createElement("param"), c.setAttribute("name", h), c
                            .setAttribute("value", k), a.appendChild(c));
    ...
    function Q(a, b, c, f) {
        if (!e.ie || !e.mac) {
            ...
            if (g) {
                ...
                f && (K = l = null);
                if (!l || K != c)
                    f = d.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), l = g
                            .appendChild(f),
                        e.ie &&
        ...
        e = function() {
            ...
            if (typeof q.plugins != i &&
                ...
                if ((h = q.plugins["Shockwave Flash"].description) &&
                    ...
                    T = !0, g = !1, h = h
                        .replace(/^.*\s+(\S+\s+\S+$)/, "$1"), e[0] = parseInt(h.replace(/^(.*)\..*$/, "$1"), 10), e[1] =
                        parseInt(h
                            .replace(/^.*\.(.*)\s.*$/, "$1"),
                            10), e[2] = /[a-zA-Z]/.test(h) ? parseInt(h.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        ...
        getQueryParamValue: function(a) {
            ...
            if (b) {
                ...
                for (var b = b
                    ...
                    c = 0;
                    c < b.length;
                    c++) if (b[c].substring(0, b[c].indexOf("=")) == a) return S(b[c].substring(b[c].indexOf("=") + 1))
            }
            return""
        },
        expressInstallCallback: function() {
            if (A) {
                ...
                a &&
                    w &&
                    (a.parentNode
                        .replaceChild(w, a), B && (t(B, !0), e.ie && e.win && (w.style.display = "block")), H && H(N));
                A = !1
            }
        }
    }
