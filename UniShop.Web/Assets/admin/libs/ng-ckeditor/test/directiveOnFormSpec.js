describe("ng-ckeditor",
    function() {
        ...
        beforeEach(inject(function($rootScope, $compile, $document) {
            elm = angular.element(
                '<form name="testForm">{{test}}<div><textarea id="' +
                "editor" +
                i +
                '" ckeditor ng-model="test"></textarea></div></form>');
        ...
        it("should create editor",
            inject(function($timeout, $rootScope, $document) {
                var flag;
                runs(function() {
        ...
        it("should change model value editor",
            inject(function($timeout, $rootScope, $document) {
                var flag;
                runs(function() {
                    flag = false;
        ...
        it("should async change model value editor",
            inject(function($timeout, $rootScope, $document) {
                var flag;
                runs(function() {
                    flag = false;
        ...
        it("should change in source view",
            inject(function($timeout, $rootScope, $document) {
                var flag;
                runs(function() {
                    flag = false;
