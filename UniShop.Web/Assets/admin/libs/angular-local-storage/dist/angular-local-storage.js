    ...
    angular
        ...
        .provider("localStorageService",
            function() {
                ...
                this.$get = [
                    "$rootScope", "$window", "$document", "$parse", "$timeout",
                    function($rootScope, $window, $document, $parse, $timeout) {
                        ...
                        var getKeysForLocalStorage = function(type) {
                            ...
                            if (!browserSupportsLocalStorage) {
                                $rootScope.$broadcast("LocalStorageModule.notification.warning",
                                    "LOCAL_STORAGE_NOT_SUPPORTED");
                                return [];
                            }
                        ...
                        var addToCookies = function(key, value, daysToExpiry, secure) {
                            ...
                            try {
                                ...
                                if (!!key) {
                                    ...
                                    $document.cookie = deriveQualifiedKey(key) +
                                        "=" +
                        ...
                        var getFromCookies = function(key) {
                            ...
                            for (var i = 0; i < cookies.length; i++) {
                                ...
                                if (thisCookie.indexOf(deriveQualifiedKey(key) + "=") === 0) {
                                    var storedValues =
                                        decodeURIComponent(thisCookie
                                            .substring(prefix.length + key.length + 1, thisCookie.length));
                                    try {
                                ...
                                if (isString(e.key) && isKeyPrefixOurs(e.key)) {
                                    ...
                                    $timeout(function() {
                                        $rootScope
                                            ...
                                            { key: key, newvalue: e.newValue, storageType: self.storageType });
                                    });
                                }
                            }
                        }
